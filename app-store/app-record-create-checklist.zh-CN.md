...
状态更新：App Store Connect App 记录已经创建，早先的 `missingApp(bundleId: "com.xiazhiyuan.flightrecorder")` 阻塞已解决。本文件保留为 App 记录创建信息备忘。build `1.0 (3)` 已在 2026-06-22 21:53 CST 成功上传，Apple 当前正在处理包。
...
上传已成功。下一步是在 App Store Connect 版本页面等待并选择 build `1.0 (3)`，然后按 `app-store/app-store-connect-final-submit.zh-CN.md` 填写中英双语材料。
